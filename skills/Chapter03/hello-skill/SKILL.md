...
name: hello-skill
description:
  Generates a compliant corporate greeting. Trigger this ONLY when the user sends a standalone greeting (e.g., "Hi", "Hello") or explicitly asks for an introduction.
  DO NOT trigger this for substantive requests (e.g., "Hi, I have a bug").
license: Apache-2.0
metadata:
